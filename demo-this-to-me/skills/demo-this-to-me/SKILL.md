...
Get what was just built onto a screen, fast. No new tooling per project — reuse what's already there.

Run [REFERENCE.md](REFERENCE.md) steps 1-3, then ask the user: desktop or mobile (skip the ask if they already said "phone"/"mobile" or "desktop" in this message) — then run the matching REFERENCE.md target section.
